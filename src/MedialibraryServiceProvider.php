...
{
    public static string $name = 'medialibrary';

    public static string $viewNamespace = 'medialibrary';
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('elfeffe/medialibrary');
            });
